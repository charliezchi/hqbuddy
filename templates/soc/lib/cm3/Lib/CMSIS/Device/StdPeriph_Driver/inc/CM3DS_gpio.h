...
#define IS_GPIO_AF(AF) (((AF) == GPIO_AF_TIM0EXTIN  ) || ((AF) == GPIO_AF_TIM1EXTIN )  ||\
                                  ((AF) == GPIO_AF_USART0_RXD ) || ((AF) ==  GPIO_AF_USART0_TXD )  ||\
                                  ((AF) == GPIO_AF_USART1_RXD ) || ((AF) ==  GPIO_AF_USART1_TXD )  ||\
                                  ((AF) ==  GPIO_AF_ADCETR  ) || ((AF) ==  GPIO_AF_SPI0_CLK  )  ||\
                                  ((AF) == GPIO_AF_SPI0_SEL  ) || ((AF) ==  GPIO_AF_SPI0_DATA0 )  ||\
                                  ((AF) == GPIO_AF_SPI0_DATA1 ) || ((AF) ==  GPIO_AF_SPI0_DATA2 )  ||\
                                  ((AF) == GPIO_AF_SPI0_DATA3 ) || ((AF) ==  GPIO_AF_SPI1_CLK )  ||\
                                  ((AF) == GPIO_AF_SPI1_SEL  ) || ((AF) ==  GPIO_AF_SPI1_DATA0 )  ||\
                                  ((AF) == GPIO_AF_SPI1_DATA1 ) || ((AF) ==  GPIO_AF_SPI1_DATA2 )  ||\
                                  ((AF) == GPIO_AF_SPI1_DATA3 ) || ((AF) ==  GPIO_AF_I2C0SCL ) ||\
                                  ((AF) == GPIO_AF_I2C0SDA ))
/**
  * @}
  */
