...
phycst.pin.set  {ADC_CH1}   D1      -attr "PULLMODE=NONE"
phycst.pin.set  {ADC_CH2}   B1      -attr "PULLMODE=NONE"
phycst.pin.set  {ADC_CH3}   A1      -attr "PULLMODE=NONE"
phycst.pin.set  {ADC_CH4}   G1      -attr "PULLMODE=NONE"
phycst.pin.set  {ADC_CH5}   F1      -attr "PULLMODE=NONE"
phycst.pin.set  {ADC_CH6}   C2      -attr "PULLMODE=NONE"
