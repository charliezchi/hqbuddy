...
set CM33BinFile=MCU_Prj\MDK\ahb_dma.bin
set fpgaAndCm3BinFile=FPGA_Prj\hq_prj\hq_run\hq_prj_ahb_dma.bin
...
:: hqdnload安装目录
set HqDnLoadDir= D:\hqui\hqv3_xist_3.0.5_FT091724_win64\build\hqdnload
