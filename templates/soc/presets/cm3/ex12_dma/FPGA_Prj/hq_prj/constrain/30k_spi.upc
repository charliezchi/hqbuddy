...
######SPI0,FLASH######
phycst.pin.set  {SPI0_SCK_OUT}  A1  -attr "IO_TYPE=LVCMOS33 PULLMODE=NONE"
phycst.pin.set  {SPI0_SEL_OUT}  A8  -attr "IO_TYPE=LVCMOS33 PULLMODE=NONE"
phycst.pin.set  {SPI0_DATA[0]}  G2  -attr "IO_TYPE=LVCMOS33 PULLMODE=NONE"
phycst.pin.set  {SPI0_DATA[1]}  G1  -attr "IO_TYPE=LVCMOS33 PULLMODE=NONE"
phycst.pin.set  {SPI0_DATA[2]}  D3  -attr "IO_TYPE=LVCMOS33 PULLMODE=NONE"
phycst.pin.set  {SPI0_DATA[3]}  C7  -attr "IO_TYPE=LVCMOS33 PULLMODE=NONE"
phycst.end
